...
<template>
  <div>
    <Header title="Rotating Navigation" />
    <MainLayout>
      <div class="nav-container" :class="{ 'show-nav': toggleNav }">
        <div class="circle-container">
          <div class="circle">
            <button id="close" @click="toggleNav = !toggleNav">
              <i class="fas fa-times"></i>
            </button>
            <button id="open" @click="toggleNav = !toggleNav">
        ...
        <div class="content">
          ...
          <h3>My Dog</h3>
          <img src="https://picsum.photos/seed/2/800/600" alt="doggy" />
          <p>
